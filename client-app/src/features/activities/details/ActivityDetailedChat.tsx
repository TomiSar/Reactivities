...
const ChatCommentItem = observer(function ChatCommentItem({ comment }: { comment: ChatComment }) {
            ...
            <Comment.Content>
                ...
                <Comment.Metadata>
                    {updatedTime ? (
                        ...
                        >
                            <span style={{ fontSize: '11px', color: 'rgba(0,0,0,.4)' }}>commented {createdTime}</span>
                            <span
                                style={{
                                    fontSize: '11px',
                                    color: 'orange',
                ...
                {isEditing ? (
                    <div style={{ marginTop: '15px' }}>
                        ...
                        <button className='ui mini button' onClick={() => setIsEditing(false)}>
                            Cancel
                        </button>
                    </div>
                ) : (
